...
### 3. 서비스 장애 복구
<img width="400" alt="image" src="https://github.com/user-attachments/assets/f40aecec-0433-4ca0-8066-a1d7708311d3" />

ReplicaSet을 사용하여 항상 지정된 개수의 Pod를 유지될 수 있도록합니다. 특정 Pod가 장애로 종료되면, 자동으로 새로운 Pod를 생성합니다.
<br/>

### 4. 사용량에 따른 오토스케일링
<img width="400" alt="image" src="https://github.com/user-attachments/assets/9fef528b-7a51-4928-885a-343f0f0af087" />
